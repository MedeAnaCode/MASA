...
var _initModals = require("./modules/modals/init-modals.js");
var _form = require("./modules/form-validate/form.js");
var _menu = require("./modules/menu.js");
var _heroSwiper = require("./modules/hero-swiper.js");
var _programsSwiper = require("./modules/programs-swiper.js");
var _feedbacksSwiper = require("./modules/feedbacks-swiper.js");
var _newsSwiper = require("./modules/news-swiper.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _programsSwiper.initProgramsSwiper)();
  (0, _feedbacksSwiper.initFeedbacksSwiper)();
  (0, _newsSwiper.initNewsSwiper)();
  (0, _initAccordion.initAccordions)();
  var customSelect = new _customSelect.CustomSelect();
  customSelect.init();
  (0, _map.initMap)();
  (0, _map.setWindowResize)();
...
},{"./modules/feedbacks-swiper.js":2,"./modules/form-validate/form.js":4,"./modules/hero-swiper.js":10,"./modules/map.js":11,"./modules/menu.js":12,"./modules/modals/init-modals.js":13,"./modules/news-swiper.js":15,"./modules/programs-swiper.js":16,"./modules/select/custom-select.js":18,"./utils/ios-vh-fix.js":22,"./vendor/init-accordion.js":25}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFeedbacksSwiper = void 0;
var initFeedbacksSwiper = function initFeedbacksSwiper() {
...
exports.initFeedbacksSwiper = initFeedbacksSwiper;
...
exports.setWindowResize = exports.initMap = void 0;
var MAP_OPTIONS = {
...
var initMap = function initMap() {
  ...
  LAYER.addTo(map);
  var pin = L.icon(pinOptions);
  var marker = new L.Marker([55.0287159597826, 82.9282572861872], {
    icon: pin
  });
  marker.addTo(map);
};
...
var setWindowResize = function setWindowResize() {
  window.addEventListener('resize', onWindowResize);
};
exports.setWindowResize = setWindowResize;
...
var nav = document.querySelector('[data-id="nav"]');
var toggle = document.querySelector('[data-id="toggle"]');
var wrapper = document.querySelector('[data-id="menu-wrapper"]');
var listItems = document.querySelectorAll('.page-header__menu-item');
var subMenuButtons = document.querySelectorAll('.page-header__submenu-button');
var subMenuItems = document.querySelectorAll('.page-header__submenu-item');
...
var onDocumentEscapeKeydown = function onDocumentEscapeKeydown(evt) {
  if (isEscapeKey(evt)) {
    evt.preventDefault();
    closeMenu();
  }
...
var onDocumentClick = function onDocumentClick() {
  document.addEventListener('click', function (evt) {
    var click = evt.composedPath().includes(wrapper);
...
var toggleSubMenu = function toggleSubMenu() {
  if (document.body.contains(document.querySelector('.page-header__submenu'))) {
    subMenuButtons.forEach(function (subMenuButton) {
      return subMenuButton.addEventListener('click', function (evt) {
        if (evt) {
          var subMenu = subMenuButton.parentElement;
...
var setMenuItemsListeners = function setMenuItemsListeners() {
  listItems.forEach(function (listItem) {
    return listItem.addEventListener('click', function (evt) {
      if (evt) {
  ...
  subMenuItems.forEach(function (subMenuItem) {
    return subMenuItem.addEventListener('click', function () {
      if (nav.classList.contains(openedClass)) {
        closeMenu();
      }
    });
...
},{"../utils/scroll-lock":23}],13:[function(require,module,exports){
"use strict";
...
exports.initProgramsSwiper = void 0;
